						...
						function r(t, e) {
							...
							(e = e || {}),
								...
								(this.perMessageDeflate =
									!1 !== e.perMessageDeflate ? e.perMessageDeflate || {} : !1),
								...
								(this.rejectUnauthorized =
									void 0 === e.rejectUnauthorized ? !0 : e.rejectUnauthorized);
												...
												if (
													...
													var a =
														"string" == typeof i
															...
															: i.length;
													a < r.perMessageDeflate.threshold &&
														(s.compress = !1);
												}
											}
											try {
						...
						(n.encodePacket = function (t, n, i, a) {
							...
							(n.decodePacket = function (t, e, r) {
								if ("string" == typeof t || void 0 === t) {
									...
									var i = t.charAt(0);
									return Number(i) == i && b[i]
										? t.length > 1
											? { type: b[i], data: t.substring(1) }
											: { type: b[i] }
										: v;
								}
								var s = new Uint8Array(t),
									...
									a = u(t, 1);
								return (
									w && "blob" === e && (a = new w([a])), { type: b[i], data: a }
								);
							}),
										...
										var j = {
											...
											U = function (t, e, n, r, o, i, s) {
												...
												if ("object" == typeof a && a)
													if (((c = b.call(a)), c != x || d.call(a, "toJSON")))
										...
										e.stringify = function (t, e, n) {
											...
											if (n)
												if ((a = b.call(n)) == A) {
													...
													a == B && (r = n.length <= 10 ? n : n.slice(0, 10));
